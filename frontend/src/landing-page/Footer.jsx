      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            ...
            <p>
              &copy; 2010 - 2024, Not Stockora Broking Ltd. All rights reserved.
            </p>
          </div>
          <div className="col">
            <p>Company</p>
            ...
            <a href="">Careers</a>
            <br />
            <a href="">Stockora.tech</a>
            <br />
            <a href="">Press & media</a>
            <br />
            <a href="">Stockora cares (CSR)</a>
            <br />
          </div>
          <div className="col">
            <p>Support</p>
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          <p>
            ...
            INZ000031633 CDSL: Depository services through Stockora Securities
            Pvt. Ltd. – SEBI Registration no.: IN-DP-100-2015 Commodity Trading
            through Stockora Commodities Pvt. Ltd. MCX: 46025 – SEBI Registration
            no.: INZ000038238 Registered Address: Stockora Broking Ltd.,
